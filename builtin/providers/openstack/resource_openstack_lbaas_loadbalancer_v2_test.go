...
func TestAccLBV2LoadBalancer_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// resource.TestStep{
			// 	Config: testAccLBV2LoadBalancer_update,
			// 	Check: resource.ComposeTestCheckFunc(
			// 		resource.TestCheckResourceAttr("openstack_lb_loadbalancer_v2.loadbalancer_1", "", ""),
			// 	),
			// },
		},
	})
...
var TestAccLBV2LoadBalancerConfig_basic = fmt.Sprintf(`
  ...
  resource "openstack_lbaas_loadbalancer_v2" "lb_1" {
	...
	vip_address = "${openstack_lb_vip_v1.vip_1.address}"
